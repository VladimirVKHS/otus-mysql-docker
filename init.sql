...
CREATE TABLE IF NOT EXISTS `otus`.`marital_statuses` (
  `id` INT NOT NULL COMMENT 'ID семейного положения',
...
CREATE TABLE IF NOT EXISTS `otus`.`customers` (
  `id` INT NOT NULL COMMENT 'Идентификатор заказчика',
...
CREATE TABLE IF NOT EXISTS `otus`.`streets` (
  `id` INT NOT NULL COMMENT 'ID улицы',
...
CREATE TABLE IF NOT EXISTS `otus`.`building_types` (
  `id` INT NOT NULL COMMENT 'ID типа строения ',
...
CREATE TABLE IF NOT EXISTS `otus`.`buildings` (
  `id` INT NOT NULL COMMENT 'ID здания (строения)',
...
CREATE TABLE IF NOT EXISTS `otus`.`manufacturers` (
  `id` INT NOT NULL COMMENT 'ID производителя',
  `name` VARCHAR(45) NULL COMMENT 'Наименование',
  `building_id` INT NULL COMMENT 'ID строения (здания)',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `otus`.`products` (
  `id` INT NOT NULL COMMENT 'ID продукта',
...
CREATE TABLE IF NOT EXISTS `otus`.`suppliers` (
  `id` INT NOT NULL COMMENT 'ID поставщика',
  `name` VARCHAR(45) NOT NULL COMMENT 'Наименование',
  `building_id` INT NULL COMMENT 'ID строения (здания)',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `otus`.`currencies` (
  `id` INT NOT NULL COMMENT 'ID валюты',
  `name` VARCHAR(45) NOT NULL COMMENT 'Наименование',
...
CREATE TABLE IF NOT EXISTS `otus`.`receipts` (
  `id` BIGINT NOT NULL COMMENT 'ID поступления товара',
  `product_id` INT NOT NULL COMMENT 'ID поступления товара',
...
CREATE TABLE IF NOT EXISTS `otus`.`order_statuses` (
  `id` INT NOT NULL COMMENT 'ID статуса покупки',
  `name` VARCHAR(45) NOT NULL COMMENT 'Наименование',
  PRIMARY KEY (`id`),
  UNIQUE INDEX `name_UNIQUE` (`name` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `otus`.`languages` (
  `id` INT NOT NULL COMMENT 'ID языка',
...
CREATE TABLE IF NOT EXISTS `otus`.`orders` (
  ...
  `product_id` INT NOT NULL COMMENT 'ID продукта',
  `price_id` INT NOT NULL COMMENT 'ID стоимости',
  ...
  CONSTRAINT `fk_orders_products1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_prices1`
    FOREIGN KEY (`price_id`)
    REFERENCES `otus`.`prices` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_customers1`
    FOREIGN KEY (`customer_id`)
    REFERENCES `otus`.`customers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_order_statuses1`
    FOREIGN KEY (`order_status_id`)
    REFERENCES `otus`.`order_statuses` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
